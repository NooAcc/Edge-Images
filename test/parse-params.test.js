...
test('parseParams enforces configured source URL allowlist', () => {
  ...
  assert.equal(
    parseParams({ url: 'https://images.example.com/photo.jpg' }, { urlAllowlist }).url,
    'https://images.example.com/photo.jpg',
  );
  assert.equal(
    parseParams({ url: 'https://assets.trusted-cdn.com/photo.jpg' }, { urlAllowlist }).url,
    'https://assets.trusted-cdn.com/photo.jpg',
  );
  assert.equal(
    parseParams({ url: 'https://trusted-cdn.com/photo.jpg' }, { urlAllowlist }).url,
